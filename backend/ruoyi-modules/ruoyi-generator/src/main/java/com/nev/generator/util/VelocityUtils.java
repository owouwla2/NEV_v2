package com.nev.generator.util;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.convert.Convert;
import cn.hutool.core.lang.Dict;
import com.nev.common.mybatis.enums.DataBaseType;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("com.nev.common.translation.annotation.Translation");
                importList.add("com.nev.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
